...
/// A class that contains all theme configurations for the hotel booking application.
class AppTheme {
  AppTheme._();

  // Hotel booking application color palette - Refined Travel Palette
  static const Color primaryLight = Color(0xFF1B365D); // Deep trust blue
  static const Color primaryVariantLight = Color(0xFF0F2A47);
  static const Color secondaryLight = Color(0xFFF7F9FC); // Clean background
  static const Color secondaryVariantLight = Color(0xFFE8ECEF);
  static const Color accentLight = Color(0xFFE67E22); // Warm booking accent
  static const Color backgroundLight = Color(0xFFF7F9FC);
  static const Color surfaceLight = Color(0xFFFFFFFF); // Surface elevated
  ...
  // Text colors - Hotel booking optimized
  static const Color textPrimaryLight = Color(0xFF2C3E50); // Text primary
  static const Color textSecondaryLight = Color(0xFF7F8C8D); // Text secondary
  ...
  /// Light theme - Contemporary Hospitality Minimalism
  ...
  /// Dark theme - Contemporary Hospitality Minimalism (Dark Mode)
